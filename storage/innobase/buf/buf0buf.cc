	...
	ulint			fsp_flags)
{
	...
	if (fil_space_t::full_crc32(fsp_flags)) {
		...
		compile_time_assert(FIL_PAGE_FCRC32_KEY_VERSION == 0);
		compile_time_assert(FIL_PAGE_LSN % 4 == 0);
		compile_time_assert(FIL_PAGE_FCRC32_END_LSN % 4 == 0);
		if (!compressed
	...
	compile_time_assert(FIL_PAGE_LSN % 4 == 0);
	compile_time_assert(FIL_PAGE_END_LSN_OLD_CHKSUM % 4 == 0);
	...
	buf_block_t*	block)
{
	...
	if (buf_page_can_relocate(&block->page)) {
		...
		compile_time_assert(FIL_PAGE_ARCH_LOG_NO_OR_SPACE_ID % 4 == 2);
	...
	mtr_t*			mtr)
{
	...
	compile_time_assert(FIL_PAGE_PREV + 4 == FIL_PAGE_NEXT);
